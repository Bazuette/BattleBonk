package libayon.gui.altmanager.components;
...
public class GuiAccountList extends GuiSlot {
	...
	public int getSize() {
		return BattleBonk.instance.getAccountManager().getAccounts().size();
	}
	...
	public Account getAccount(int i) {
		return BattleBonk.instance.getAccountManager().getAccounts().get(i);
	}
	...
	public void removeSelected() {
		if (this.selected == -1)
			return;
		BattleBonk.instance.getAccountManager().getAccounts().remove(getAccount(this.selected));
