...
public class GuiAlteningLogin extends GuiScreen {
	...
	protected void actionPerformed(GuiButton button) {
		...
		case -1:
			if (key.getText().isEmpty() || token.getText().isEmpty())
				return;
			BattleBonk.instance.getAccountManager().setAlteningKey(key.getText());
			BattleBonk.instance.getAccountManager().setLastAlteningAlt(token.getText());
		...
		case 2:
			...
			break;
		case 3:
			if (key.getText().isEmpty() || BattleBonk.instance.getAccountManager().getLastAlteningAlt() == null)
				return;
			BattleBonk.instance.getAccountManager().setAlteningKey(key.getText());
			thread = new AccountLoginThread(BattleBonk.instance.getAccountManager().getLastAlteningAlt().replaceAll(" ", ""), "gaymer");
			thread.run();
			BattleBonk.instance.getAccountManager().save();
			break;
		}
	...
	public void initGui() {
		...
		if (BattleBonk.instance.getAccountManager().getAlteningKey() != null)
			key.setText(BattleBonk.instance.getAccountManager().getAlteningKey());
