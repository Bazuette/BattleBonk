...
public class GuiBind extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		int currentBoundTextFontSize = BattleBonk.instance.getFontRenderer().getFontSize() - 3;
		int escapeTextFontSize = BattleBonk.instance.getFontRenderer().getFontSize() - 8;
