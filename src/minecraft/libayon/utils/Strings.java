...
public class Strings {
	...
	public static String translateColors(String string) {
		...
		for (int wordIndex = 0; wordIndex < raw.length; wordIndex++) {
			...
			for (int charIndex = 0; charIndex < chars.length; charIndex++) {
				...
				String color = String.valueOf(c) + nextChar;
				if (!(isColor(color)))
					continue;
	...
	public static int getStringWidthCFR(String text) {
		return getStringWidthCFR(text, BattleBonk.instance.getFontRenderer().getFontSize());
	}
	...
	public static int getStringWidthCFR(String text, int fontSize) {
		return BattleBonk.instance.getFontRenderer().getFont(fontSize).getStringWidth(stripColors(text));
	}

	public static int getStringHeightCFR(String text) {
		return getStringHeightCFR(text, BattleBonk.instance.getFontRenderer().getFontSize());
	}

	public static int getStringHeightCFR(String text, int fontSize) {
		return BattleBonk.instance.getFontRenderer().getFont(fontSize).getStringHeight(stripColors(text));
	}
