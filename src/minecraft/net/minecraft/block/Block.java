...
import libayon.event.events.player.CollideEvent;
...
public class Block {
	...
	public int getMixedBrightnessForBlock(IBlockAccess worldIn, BlockPos pos) {
		BlockBrightnessRequestEvent event = (BlockBrightnessRequestEvent) BattleBonk.instance.getEventManager().call(new BlockBrightnessRequestEvent(this));
...
//	}
	...
	public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
		...
		CollideEvent event = (CollideEvent) BattleBonk.instance.getEventManager().call(new CollideEvent(collidingEntity, axisalignedbb, this));
