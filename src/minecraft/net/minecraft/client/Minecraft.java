...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private final List<Integer> buttonsDown;
    ...
    private void createDisplay() throws LWJGLException {
        ...
        this.baseClient = BattleBonk.instance;
    ...
    private void handleButtonClick(int button) {
        ...
        BattleBonk.instance.getEventManager().call(new MouseClickEvent(button));
    }
            ...
            while (Mouse.next()) {
                ...
                if (i1 <= 200L) {
                    ...
                    if (j != 0) {
                        ...
                        if (!(((MouseScrollEvent) BattleBonk.instance.getEventManager().call(new MouseScrollEvent(j))).isCancelled())) {
