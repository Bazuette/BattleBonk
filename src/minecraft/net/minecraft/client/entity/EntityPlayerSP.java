...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            BattleBonk.instance.getEventManager().call(new UpdateEvent());
            ...
            if (this.isRiding()) {
                ...
                PreMotionEvent pre = new PreMotionEvent(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
                BattleBonk.instance.getEventManager().call(pre);
                this.posX = pre.getX();
                this.posY = pre.getY();
                this.posZ = pre.getZ();
                this.rotationYaw = pre.getYaw();
                this.rotationPitch = pre.getPitch();
                this.onGround = pre.onGround();

                this.onUpdateWalkingPlayer();

                BattleBonk.instance.getEventManager().call(new PostMotionEvent());
            }
        }
    }
    ...
    public void sendChatMessage(String message) {
        MessageSentEvent messageSentEvent = (MessageSentEvent) BattleBonk.instance.getEventManager().call(new MessageSentEvent(message));
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            SlowDownEvent event = (SlowDownEvent) BattleBonk.instance.getEventManager().call(new SlowDownEvent(0.2F));
