...
import libayon.event.events.player.MessageReceivedEvent;
...
public class GuiNewChat extends Gui {
	...
	public void printChatMessageWithOptionalDeletion(IChatComponent chatComponent, int id, boolean fromMinecraft) {
		...
		if (fromMinecraft) {
			MessageReceivedEvent event = (MessageReceivedEvent) BattleBonk.instance.getEventManager().call(new MessageReceivedEvent(message, fromMinecraft));
