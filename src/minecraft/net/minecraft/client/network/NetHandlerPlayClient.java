...
import libayon.event.events.player.PlayerSpawnEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
	...
	public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn) {
		...
		PlayerSpawnEvent event = (PlayerSpawnEvent) BattleBonk.instance.getEventManager().call(new PlayerSpawnEvent(entityotherplayermp));
