        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() == Items.filled_map) {
                ...
                switch (enumaction) {
                    ...
                    case BLOCK:
                        float funny = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                        GL11.glTranslated(0.1D, 0.1D, 0.1D);
                        transformFirstPersonItem(f, 0.0F);
                        GL11.glTranslatef(0.1F, 0.4F, -0.1F);
                        GL11.glRotated((-funny * 42.0F), (funny / 2.0F), 0.0D, 9.0D);
                        GL11.glRotated((-funny * 50.0F), 0.800000011920929D, (funny / 2.0F), 0.0D);
