	...
	public void func_181679_a(WorldRenderer p_181679_1_) {
		if (p_181679_1_.getVertexCount() > 0) {
			...
			for (int j = 0; j < list.size(); ++j) {
				...
				if (flag) {
					Reflector.callVoid(vertexformatelement$enumusage, Reflector.ForgeVertexFormatElementEnumUseage_preDraw, vertexformatelement, Integer.valueOf(i), bytebuffer);
				} else {
			...
			for (int k1 = list.size(); i1 < k1; ++i1) {
				...
				if (flag1) {
					Reflector.callVoid(vertexformatelement$enumusage1, Reflector.ForgeVertexFormatElementEnumUseage_postDraw, vertexformatelement1, Integer.valueOf(i), bytebuffer);
				} else {
