...
import libayon.event.events.render.RenderLivingLabelEvent;
...
public abstract class Render<T extends Entity> {
	...
	protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
		RenderLivingLabelEvent event = (RenderLivingLabelEvent) BattleBonk.instance.getEventManager().call(new RenderLivingLabelEvent(entityIn, str));
