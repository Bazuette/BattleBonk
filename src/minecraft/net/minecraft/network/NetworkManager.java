...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, Packet packetIn) throws Exception {
        if (this.channel.isOpen()) {
            try {
                PacketReceivedEvent packetReceivedEvent = (PacketReceivedEvent) BattleBonk.instance.getEventManager().call(new PacketReceivedEvent(packetIn));
    ...
    public void sendPacket(Packet packetIn) {
        ...
        PacketSentEvent packetSentEvent = (PacketSentEvent) BattleBonk.instance.getEventManager().call(new PacketSentEvent(packetIn));
