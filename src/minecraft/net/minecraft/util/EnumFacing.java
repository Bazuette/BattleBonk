...
public enum EnumFacing implements IStringSerializable {
	...
	EnumFacing(String p_i13_3_, int p_i13_4_, int p_i13_5_, int p_i13_6_, int p_i13_7_, String p_i13_8_, EnumFacing.AxisDirection p_i13_9_, EnumFacing.Axis p_i13_10_, Vec3i p_i13_11_) {
		this.index = p_i13_5_;
	...
	public enum Axis implements Predicate, IStringSerializable {
		...
		Axis(String p_i10_3_, int p_i10_4_, String p_i10_5_, EnumFacing.Plane p_i10_6_) {
			this.name = p_i10_5_;
			this.plane = p_i10_6_;
		}
	...
	public enum Plane implements Predicate, Iterable {
		...
		Plane(String p_i12_3_, int p_i12_4_) {
		}
